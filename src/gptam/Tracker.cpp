...
#include "gptam/ShiTomasi.h"

#include "gptam/PatchFinder.h"
#include "gptam/TrackerData.h"

// The two possible map initializers:
#include "gptam/HomographyInit.h"   // homography initializer 
#include "gptam/EssentialInit.h"    // essential matrix initializer (used below, but could be changed)
